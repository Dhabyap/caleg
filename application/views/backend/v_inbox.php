                    ...
                    <div class="row m-t-md">
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="data-relawan" class="display table table-striped table-bordered datatable-extended">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                     foreach($relawan as $list) :
                                      ?>
                                    <tr>
                                        <td><?= $no; ?></td>
                                        <td><?= $list->nik; ?></td>
                                        <td><?= $list->inbox_name; ?></td>
                                        <td><?= $list->phone; ?></td>
                                        <td><?= $list->inbox_email; ?></td>
                                        <td><?= $list->provinsi; ?></td>
                                        <td><?= $list->kota; ?></td>
                                        <td><?= $list->kecamatan; ?></td>
                                        <td><?= $list->kelurahan; ?></td>
                                        <td><a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $list->inbox_id;?>" title="Hapus"><span class="fa fa-trash"></span></a></td>
                                    </tr>
                                    <?php $no++ ;
                                    endforeach; ?>
                                </tbody>
