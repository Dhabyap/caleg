...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                            ...
                            <table id="data-relawan" class="display table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $list->nama_kecamatan; ?></td>
                                        <td><?= $list->nama_kelurahan; ?></td>
                                        <td><?= $list->desa; ?></td>
                                        <td><?= $list->rw; ?></td>
                                        <td><?= $list->rt; ?></td>
                                        <td><?= $list->tps; ?></td>
                                        <td><?= $list->jumlah_suara; ?></td>
                                        <td><a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $list->id;?>" title="Hapus"><span class="fa fa-trash"></span></a></td>
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('backend/inbox/delete_suara');?>" method="post">
