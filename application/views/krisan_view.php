							...
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="blog-item clearfix">						
									...
									<div class="comments-heading text-center mb-30">
										<hgroup>
											<h2 class="font-face1 section-heading"><b>Kritik dan Saran</b></h2></h2>
										</hgroup>									
									</div>
									<?php echo $this->session->flashdata('msg');?>
									<form method="post" action="<?php echo site_url('contact/send_kritik');?>" role="form" class="form">
									...
									<div class="form-group col-md-12 mx-auto">
										...
										<input type="email" class="form-control" style="text-transform: lowercase;" required id="email" name="email" autocomplete="off"  placeholder="E-mail*">
									</div>
									<div class="form-group col-md-12 mx-auto">
										<label for="kritik">Kritik dan Saran</label>
										<textarea type="text" class="form-control" required id="kritik" name="kritik" placeholder="Kritik dan Saran*"></textarea>
									</div>
