							...
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="blog-item clearfix">						
									...
									<div class="comments-heading text-center mb-30">
										<hgroup>
											<h2 class="font-face1 section-heading"><b>Form Pendaftaran Relawan</b></h2></h2>
										</hgroup>									
									</div>
									...
									<div class="form-group col-md-12 mx-auto mt-2">
										...
										<input type="number" class="form-control" style="text-transform: lowercase;" required id="nik" name="nik" placeholder="NIK*">
									</div>
									<div class="form-group col-md-12 mx-auto">
										<label for="nama">Nama</label>
										<input type="text" class="form-control" style="text-transform: lowercase;" required id="nama" name="nama" placeholder="Nama*">
									</div>
									<div class="form-group col-md-12 mx-auto">
										<label for="email">Jabatan</label>
										<input type="text" class="form-control" style="text-transform: lowercase;" required id="email" name="email" autocomplete="off"  placeholder="Jabatan">
									</div>
									<div class="form-group col-md-12 mx-auto">
									...
									<div class="form-group col-md-12 mx-auto">
										...
										<select class="form-control" id="provinsi" name="provinsi" onchange="get_kota(this.value)">
									...
									<div class="form-group col-md-12 mx-auto">
										...
										<select class="form-control" id="regencies" name="regencies" onchange="get_kecamatan(this.value)">
										</select>
									</div>
									<div class="form-group col-md-12 mx-auto">
										<label for="districts">Kecamatan</label>
										<select class="form-control" id="districts" name="districts" onchange="get_kelurahan(this.value)">
										</select>
									</div>
									<div class="form-group col-md-12 mx-auto">
									...
									<div class="form-group col-md-12 mx-auto">
										...
										<input type="text" class="form-control" style="text-transform: lowercase;" required  id="alamat" name="alamat"  placeholder="Alamat*">
									</div>
									<!-- <div class="form-group col-md-12 mx-auto mt-5 mb-5">
										<div class="form-row">
											<div class="col-md-2">
												<label for="validationTooltip01">KTP*</label>
											</div>
											<div class="col-md-10">
