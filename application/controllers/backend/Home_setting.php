...
class Home_setting extends CI_Controller{
	...
	function index(){
		...
		$datas['home_id'] = $data->home_id;
		$datas['caption_1'] = $data->home_caption_1;
		$datas['caption_2'] = $data->home_caption_2;
		$datas['image_heading'] = $data->home_bg_heading;
		$datas['image_testimonial'] = $data->home_bg_testimonial;
		$v['title'] = 'Home Setting' ;
		$datas['footer'] = $this->load->view('backend/v_header',$v,TRUE);
		$datas['sidebar'] = $this->load->view('backend/v_sidebar','',TRUE);
		$this->load->view('backend/v_home_setting',$datas);
	}
