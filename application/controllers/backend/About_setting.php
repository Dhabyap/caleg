...
class About_setting extends CI_Controller{
	...
	function index(){
		...
		$datas['about_id'] = $data->about_id;
		$datas['about_img'] = $data->about_image;
		$datas['about_desc'] = $data->about_description;
		$v['title'] = 'About Setting' ;
		$datas['footer'] = $this->load->view('backend/v_header',$v,TRUE);
		$datas['sidebar'] = $this->load->view('backend/v_sidebar','',TRUE);
		$this->load->view('backend/v_about_setting',$datas);
	}
